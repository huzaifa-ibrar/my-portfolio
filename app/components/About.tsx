...
const About = () => {
  ...
  const skills = [
    ...
    { name: 'Groovy', icon: <FaFileCode className="w-full h-full" />, category: 'language' },
    ...
    { name: 'YAML', icon: <SiYaml className="w-full h-full" />, category: 'language' },
    
    // DevOps & Cloud
    { name: 'Jenkins', icon: <SiJenkins className="w-full h-full" />, category: 'devops' },
    ...
    { name: 'CI/CD', icon: <FaCode className="w-full h-full" />, category: 'devops' },
    
    // Data & Analytics
    { name: 'SQL', icon: <FaDatabase className="w-full h-full" />, category: 'data' },
    { name: 'Git', icon: <FaGitAlt className="w-full h-full" />, category: 'data' },
    { name: 'GitHub', icon: <FaGithub className="w-full h-full" />, category: 'data' },
  ];
  ...
  return (
    <section id="about" className="py-24 md:py-32 relative overflow-hidden bg-gradient-to-b from-black to-dark">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          <h2 className="text-5xl md:text-6xl font-bold mb-6 glow-text bg-clip-text text-transparent bg-gradient-to-r from-primary to-red-300">About Me</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          >
            ...
            >
              <div className="p-1 bg-gradient-to-r from-primary via-red-400 to-primary"></div>
              <div className="p-8">
                ...
                <div className="space-y-6">
                  ...
                  >
                    <h4 className="text-2xl font-bold text-primary mb-2">University of Toronto</h4>
                    <p className="text-xl text-light/90">Toronto, Canada</p>
                    <p className="font-medium mt-4 text-light/80 text-lg">Bachelor of Science (B.S) - Computer Science, Mathematics and Statistics</p>
                    <p className="text-light/60 mt-2">Expected Graduation: 06/2026</p>
                  </motion.div>
                  
                  <div className="mt-8">
                    <h5 className="text-xl font-semibold text-light mb-4">Focus Areas</h5>
                    <div className="flex flex-wrap gap-3">
                      {['Computer Science', 'Mathematics', 'Statistics', 'Data Analysis'].map((area, index) => (
                        <motion.span
                          key={index}
            ...
            <div className="mt-12 grid grid-cols-1 gap-6">
              {['Programming Languages', 'DevOps & Cloud', 'Security Practices', 'Data & Analytics'].map((category, index) => (
                <motion.div
                  key={index}
                ...
                >
                  ...
                  <p className="text-light/80">
                    {index === 0 && "Python, Groovy, Java, C++, YAML"}
                    {index === 1 && "Jenkins, Terraform, AWS, Docker, Kubernetes, CI/CD"}
                    {index === 2 && "DevSecOps, Cloud Security, Vulnerability Assessment"}
                    {index === 3 && "SQL, Data Engineering, Machine Learning Fundamentals"}
                  </p>
                </motion.div>
              ))}
            </div>
